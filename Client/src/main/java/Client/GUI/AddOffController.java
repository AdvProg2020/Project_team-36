...
import Client.Controllers.NewOffController;
...
public class AddOffController extends SellerPersonalInfoController implements Initializable {
    ...
    @FXML
    private TableColumn<Client.Models.Product,?> availableProductsColumn;
    @FXML
    private TableView<Client.Models.Product> availableProductsTable;
    @FXML
    private TableColumn<Client.Models.Product,?> productsIncludedColumn;
    @FXML
    private TableView<Client.Models.Product> productsIncludedTable;
    @FXML
    ...
    private void setAvailableProducts(){
        List<Client.Models.Product> availableProducts = ((Client.Models.Seller)user).getAllProducts();
