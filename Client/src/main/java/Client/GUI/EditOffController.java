...
import Client.Controllers.SellerController;
...
public class EditOffController extends SellerProfileController implements Initializable {
    ...
    @FXML private TableView<Client.Models.Product> productsIncludedTable;
    @FXML private TableView<Client.Models.Product> availableProductsTable;
    @FXML private TableColumn<?, ?> availableProductsColumn;
    @FXML private TableColumn<?, ?> productsIncludedColumn;
    @FXML private Label idLabel;
    private User user;
    private ArrayList<Client.Models.Product> selectedProducts = new ArrayList<>();
    private final Client.Models.Sale offToEdit = Constants.sellerController.getOffToEdit();
    ...
    private void setAvailableProducts(){
        ...
        ArrayList<Client.Models.Product> availableProducts = new ArrayList<>(((Client.Models.Seller)user).getAllProducts());
        for (Client.Models.Product product : selectedProducts) {
    ...
    public void removeAction(ActionEvent actionEvent) {
        TableView.TableViewSelectionModel<Client.Models.Product> selectedProduct = productsIncludedTable.getSelectionModel();

        if (selectedProduct.isEmpty()) {
            return;
        }

        Client.Models.Product toBeRemoved = selectedProduct.getSelectedItem();
    ...
    public void addAction(ActionEvent actionEvent) {
        TableView.TableViewSelectionModel<Client.Models.Product> selectedProduct = availableProductsTable.getSelectionModel();

        if (selectedProduct.isEmpty()) {
            return;
        }

        Client.Models.Product toBeAdded = selectedProduct.getSelectedItem();
    ...
    public void editOff() {
        Client.Models.Sale copiedOff = Constants.sellerController.getOffCopy(offToEdit);
        LocalDate start = startDate.getValue();
        LocalDate end = endDate.getValue();
